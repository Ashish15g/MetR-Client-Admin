...
public class Login {
	...
	//UserApp LogOut WebElement
	public @FindBy(xpath = "//span[text()='m']")
	WebElement userApp_M;//logout section
	public @FindBy(xpath = "//a[contains(text(),'Sign out')]")
	WebElement ua_SinOut;
	public @FindBy(xpath = "//button[text()='Logout']")
	WebElement ua_LogOut;

	// Client Admin LogOut webElement.
	...
	public void userAppLogout() {
		ActionDriver.highlightElement(userApp_M, "green");
		ActionDriver.waitForElementToBeClickable(userApp_M);
		ActionDriver.click(userApp_M);
		ActionDriver.click(ua_SinOut);
		ActionDriver.click(ua_LogOut);
	}
